...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function changeLogoOnScroll() {
      if (window.scrollY > 0) {
        ...
        // header.style.backgroundColor = '#fff'; // Change background color to white if needed
      } else {
        whiteLogo.style.display = 'block';
        blackLogo.style.display = 'none';
        // header.style.backgroundColor = '#333'; // Change background color to original if needed
      }
    }
